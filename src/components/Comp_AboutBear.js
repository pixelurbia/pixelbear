      ...
      <div className="section-text">
        <div className="banner" style={{backgroundImage: `url(${banner})`}}></div>
          ...
          <p>
            ...
            <br /><br />
            When I am not creating, I like to unwind with my favorite video game, watch Star Trek reruns or get lost out in the mountains with my overlanding group of friends. 
            </span>
          </p>
